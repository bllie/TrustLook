...
/*
	private class UploadTask extends AsyncTask<String, Void, String> {
		@Override
		protected String doInBackground(String... appMd5) {
			
			Log.d(TAG, "Uploading app (md5: " + appMd5 + ")");
			Map<String, String> interestMap = AppListService.getInstance().getInterestMap();
			
			JSONArray arr = new JSONArray();
			for (String md5 : interestSet) {
				arr.put(md5);
			}
			return PkgUtils.askTrustLook("", arr);
		}
